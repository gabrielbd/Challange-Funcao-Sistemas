...
namespace WebAtividadeEntrevista
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/CreateBeneficiarios").Include(
                     "~/Scripts/Beneficiarios/CreateBeneficiarios.js"));

            bundles.Add(new ScriptBundle("~/bundles/GetBeneficiarios").Include(
                      "~/Scripts/Beneficiarios/GetBeneficiarios.js"));

            bundles.Add(new ScriptBundle("~/bundles/UpdateBeneficiarios").Include(
                     "~/Scripts/Beneficiarios/UpdateBeneficiarios.js"));
